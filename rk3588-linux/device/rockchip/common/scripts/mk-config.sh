#!/bin/bash -e
# switch_defconfig 选择配置文件
# rockchip_defconfigs 获取配置文件列表
# choose_defconfig 列出文件列表，并根据序号做出选择
# choose_chip 选择chip，如选择rk3562
# prepare_config 选择整合，如果没做配置，会运行该函数
# clean_hook 清理配置
# usage_hook 打印功能列表
# init_hook 功能选择
...
usage_hook()
{
	echo -e "default choose                   \trockchip_rk3562_topeet_defconfig"
